        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#111111] border border-white/10 rounded-xl p-6">
              ...
              <div className="border-2 border-dashed border-white/10 rounded-xl p-8 text-center hover:border-[#FFD400]/50 transition-colors cursor-pointer group">
                <ImageIcon className="w-10 h-10 text-gray-500 mx-auto mb-3 group-hover:text-[#FFD400] transition-colors" />
                <p className="text-sm text-white font-medium">Click to upload or drag and drop</p>
                <p className="text-xs text-gray-500 mt-1">SVG, PNG, JPG or GIF (max. 800x400px)</p>
                
                {/* Fallback URL Input for dummy data testing */}
